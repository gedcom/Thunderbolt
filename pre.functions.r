# Altered version of gplots::rich.colors with a nicer distribution of colours.
better.colours = function (n, palette = "temperature", alpha = 1, do.rgb = FALSE, plot = FALSE) 
{
  if (n <= 0) 
    return(character(0))
